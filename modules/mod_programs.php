...
if ($action == 'list')
{
    ...
    foreach ($result as $row)
    {
        ...
        $programs_list .= $skin->output('tpl_programs_item');
    }
    ...
    $module_data = $skin->output('tpl_programs');
}
else if ($action == 'editor')
{
    ...
    $skin->assign(array(
        ...
        'delete_url'        => "?q=programs&a=delete&p={$id}",
        'delete_visibility' => $id > 0 ? 'visible' : 'hidden',
    ));

    // Output the module
    $module_title = $page_title;
    $module_data = $skin->output('tpl_programs_editor');
}
else if ($action == 'delete')
{
    ...
    $skin->assign(array(
        ...
        'cancel_url'        => "?q=programs&a=editor&p={$id}",
    ));
